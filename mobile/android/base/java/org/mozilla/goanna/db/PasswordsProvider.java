...
import org.mozilla.goanna.GoannaMessageReceiver;
...
public class PasswordsProvider extends SQLiteBridgeContentProvider {
    ...
    private static final String LOG_TAG = "GoannaPasswordsProvider";
    ...
    static {
        ...
        DISABLED_HOSTS_PROJECTION_MAP.put(GoannaDisabledHosts.HOSTNAME, GoannaDisabledHosts.HOSTNAME);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case DISABLED_HOSTS:
                return GoannaDisabledHosts.CONTENT_TYPE;
    ...
    public void setupDefaults(Uri uri, ContentValues values)
        ...
        switch (match) {
            ...
            case DISABLED_HOSTS:
                if (!values.containsKey(GoannaDisabledHosts.HOSTNAME)) {
    ...
    public void initGoanna() {
        ...
        // communicate with Goanna in the main process.
        Intent initIntent = new Intent(getContext(), GoannaMessageReceiver.class);
        initIntent.setAction(GoannaApp.ACTION_INIT_PW);
