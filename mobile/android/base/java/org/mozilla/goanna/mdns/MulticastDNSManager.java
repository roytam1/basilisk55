...
package org.mozilla.goanna.mdns;
...
public abstract class MulticastDNSManager {
    ...
    protected static final String LOGTAG = "GoannaMDNSManager";
...
class MulticastDNSEventManager {
    ...
    private void registerEvents() {
        EventDispatcher.getInstance().registerGoannaThreadListener(mListener,
    ...
    private void unregisterEvents() {
        EventDispatcher.getInstance().unregisterGoannaThreadListener(mListener,
                "NsdManager:DiscoverServices",
                "NsdManager:StopServiceDiscovery",
                "NsdManager:RegisterService",
                "NsdManager:UnregisterService",
...
class NsdMulticastDNSManager extends MulticastDNSManager implements BundleEventListener {
    ...
    @TargetApi(16)
    public static GoannaBundle toBundle(final NsdServiceInfo serviceInfo) {
        final GoannaBundle obj = new GoannaBundle();
...
class DiscoveryListener implements NsdManager.DiscoveryListener {
    ...
    private static final String LOGTAG = "GoannaMDNSManager";
    private final NsdManager nsdManager;
