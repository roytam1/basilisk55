...
import org.mozilla.goanna.icons.loader.ContentProviderLoader;
import org.mozilla.goanna.icons.loader.DataUriLoader;
import org.mozilla.goanna.icons.loader.DiskLoader;
import org.mozilla.goanna.icons.loader.IconDownloader;
import org.mozilla.goanna.icons.loader.IconGenerator;
import org.mozilla.goanna.icons.loader.IconLoader;
import org.mozilla.goanna.icons.loader.JarLoader;
import org.mozilla.goanna.icons.loader.LegacyLoader;
import org.mozilla.goanna.icons.loader.MemoryLoader;
import org.mozilla.goanna.icons.preparation.AboutPagesPreparer;
import org.mozilla.goanna.icons.preparation.AddDefaultIconUrl;
import org.mozilla.goanna.icons.preparation.FilterKnownFailureUrls;
import org.mozilla.goanna.icons.preparation.FilterMimeTypes;
import org.mozilla.goanna.icons.preparation.FilterPrivilegedUrls;
import org.mozilla.goanna.icons.preparation.LookupIconUrl;
import org.mozilla.goanna.icons.preparation.Preparer;
import org.mozilla.goanna.icons.processing.ColorProcessor;
import org.mozilla.goanna.icons.processing.DiskProcessor;
import org.mozilla.goanna.icons.processing.MemoryProcessor;
import org.mozilla.goanna.icons.processing.Processor;
import org.mozilla.goanna.icons.processing.ResizingProcessor;
    ...
    static {
        final ThreadFactory factory = new ThreadFactory() {
            ...
            public Thread newThread(@NonNull Runnable runnable) {
                Thread thread = new Thread(runnable, "GoannaIconTask");
