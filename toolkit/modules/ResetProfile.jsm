...
//For Basilisk: Hard-code MOZ_APP_NAME to firefox because of hard-coded type in migrator.
const MOZ_APP_NAME = (AppConstants.MOZ_APP_NAME == "basilisk") ? "firefox" : AppConstants.MOZ_APP_NAME;
