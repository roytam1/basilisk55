...
package org.mozilla.goanna.feeds.action;
...
import org.mozilla.goanna.feeds.FeedFetcher;
import org.mozilla.goanna.feeds.FeedService;
import org.mozilla.goanna.feeds.parser.Feed;
import org.mozilla.goanna.feeds.subscriptions.FeedSubscription;
...
public class CheckForUpdatesAction extends FeedAction {
    ...
    private NotificationCompat.Action createNotificationSettingsAction() {
        final Intent intent = new Intent(GoannaApp.ACTION_LAUNCH_SETTINGS);
        intent.setClassName(AppConstants.ANDROID_PACKAGE_NAME, AppConstants.MOZ_ANDROID_BROWSER_INTENT_CLASS);
        intent.putExtra(EXTRA_CONTENT_NOTIFICATION, true);

        GoannaPreferences.setResourceToOpen(intent, "preferences_notifications");
