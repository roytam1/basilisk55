...
public class BrowserSearch extends HomeFragment
    ...
    public void onResume() {
        ...
        mSavedSearchesEnabled = prefs.getBoolean(GoannaPreferences.PREFS_HISTORY_SAVED_SEARCH, true);
    ...
    private void handleAutocomplete(String searchTerm, Cursor c) {
        ...
        GoannaAppShell.notifyObservers("Session:Prefetch", "http://" + autocompletion);
    ...
    private String findAutocompletion(String searchTerm, Cursor c, boolean searchPath) {
        ...
        do {
            ...
            if (searchCount == 0) {
                ...
                GoannaAppShell.notifyObservers("Session:Prefetch", url);
            }
    ...
    private void setSearchEngines(final GoannaBundle data) {
        ThreadUtils.assertOnUiThread();
        ...
        final GoannaBundle suggest = data.getBundle("suggest");
        ...
        for (int i = 0; i < engines.length; i++) {
            final GoannaBundle engineBundle = engines[i];
    ...
    private void setSuggestionsEnabled(final boolean enabled) {
        ...
        PrefsHelper.setPref(GoannaPreferences.PREFS_SEARCH_SUGGESTIONS_ENABLED, enabled);
