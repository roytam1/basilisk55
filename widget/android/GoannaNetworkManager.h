...
#ifndef GoannaNetworkManager_h
#define GoannaNetworkManager_h
...
class GoannaNetworkManager final
    : public java::GoannaNetworkManager::Natives<GoannaNetworkManager>
{
    GoannaNetworkManager() = delete;
