    ...
    public void onStart() {
        ...
        if (context != null) {
            try {
                ...
                Log.w("GoannaInstTestRunner", "Got SecurityException: not disabling keyguard and not taking wakelock.");
            }
        } else {
            Log.w("GoannaInstTestRunner", "Application target context is null: not disabling keyguard and not taking wakelock.");
        }
