...
public final class MediaDrmProxy {
    private static final String LOGTAG = "GoannaMediaDrmProxy";
    ...
    public static class MediaDrmProxyCallbacks implements GoannaMediaDrm.Callbacks {
