...
public class testUnifiedTelemetryClientId extends JavascriptBridgeTest {
    ...
    public void tearDown() throws Exception {
        // Don't clear cache because who knows what state Goanna is in.
        deleteClientIDFiles();
        super.tearDown();
    }
    ...
    public void testUnifiedTelemetryClientId() throws Exception {
        ...
        // Important note: we cannot stop Goanna from running while we run this test and
        // Goanna is capable of creating client ID files while we run this test. However,
    ...
    private void testJavaCreatesClientId() throws Exception {
        ...
        // allow for the case where goanna updates the client ID after the first get
    ...
    /**
     * Must be called after Goanna is loaded.
     */
     ...
     * Goanna is loaded or else this method will hang.
     *
