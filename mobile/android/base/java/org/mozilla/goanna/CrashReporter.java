...
public class CrashReporter extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Notify GoannaApp that we've crashed, so it can react appropriately during the next start.
        try {
            File crashFlag = new File(GoannaProfileDirectories.getMozillaDirectory(this), "CRASHED");
            crashFlag.createNewFile();
        } catch (GoannaProfileDirectories.NoMozillaDirectoryException | IOException e) {
        ...
        SharedPreferences prefs = GoannaSharedPrefs.forCrashReporter(this);
    ...
    private void savePrefs() {
        SharedPreferences.Editor editor = GoannaSharedPrefs.forCrashReporter(this).edit();
