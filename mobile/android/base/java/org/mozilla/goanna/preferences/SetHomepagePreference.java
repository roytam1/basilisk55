...
public class SetHomepagePreference extends DialogPreference {
    ...
    public SetHomepagePreference(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        prefs = GoannaSharedPrefs.forProfile(context);
    }
    ...
    protected void onBindDialogView(final View view) {
        ...
        storedUrl = prefs.getString(GoannaPreferences.PREFS_HOMEPAGE, DEFAULT_HOMEPAGE);
    ...
    protected void onDialogClosed(final boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            if (homepageLayout.getCheckedRadioButtonId() == R.id.radio_default ||
                ...
                newPrefValue = "";
                editor.remove(GoannaPreferences.PREFS_HOMEPAGE);
            } else {
                newPrefValue = homePageEditTextValue;
                editor.putString(GoannaPreferences.PREFS_HOMEPAGE, newPrefValue);
            }
            editor.apply();
