...
class ChromeCastPlayer implements GoannaMediaPlayer {
    ...
    private class VideoPlayCallback implements ResultCallback<ApplicationConnectionResult>,
        ...
        public void onStatusUpdated() {
            ...
            case MediaStatus.PLAYER_STATE_PLAYING:
                GoannaAppShell.notifyObservers("MediaPlayer:Playing", null);
                break;
            case MediaStatus.PLAYER_STATE_PAUSED:
                GoannaAppShell.notifyObservers("MediaPlayer:Paused", null);
                break;
            case MediaStatus.PLAYER_STATE_IDLE:
                // TODO: Do we want to shutdown when there are errors?
                if (mediaStatus.getIdleReason() == MediaStatus.IDLE_REASON_FINISHED) {
                    GoannaAppShell.notifyObservers("Casting:Stop", null);
                }
                break;
            default:
    ...
    class MirrorChannel implements MessageReceivedCallback {
        ...
        public void onMessageReceived(CastDevice castDevice, String namespace,
                                      String message) {
            GoannaAppShell.notifyObservers("MediaPlayer:Response", message);
        }
    ...
    private class MirrorCallback implements ResultCallback<ApplicationConnectionResult> {
        ...
        public void onResult(ApplicationConnectionResult result) {
            ...
            if (status.isSuccess()) {
                ...
                GoannaAppShell.notifyObservers("Casting:Mirror", route.getId());
            } else {
                sendError(callback, status.toString());
            }
        }
    ...
    private static final String LOGTAG = "GoannaChromeCastPlayer";
