...
class TestDocker(unittest.TestCase):
    ...
    def test_generate_context_hash(self):
        ...
        old_GOANNA = docker.GOANNA
        docker.GOANNA = tmpdir
        try:
            ...
            os.chmod(p, MODE_STANDARD)
            self.assertEqual(
                docker.generate_context_hash(docker.GOANNA,
                                             os.path.join(docker.GOANNA, 'docker/my-image'),
                                             'my-image'),
                'e61e675ce05e8c11424437db3f1004079374c1a5fe6ad6800346cebe137b0797'
            )
        finally:
            docker.GOANNA = old_GOANNA
