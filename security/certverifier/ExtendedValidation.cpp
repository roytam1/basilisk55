...
// As of TenFourFox FPR9, the oid_tag member is now moved into separate
// arrays so that we can more easily maintain EV roots from ESR60+
// (TenFourFox issue 512). We can just cut and paste now.
