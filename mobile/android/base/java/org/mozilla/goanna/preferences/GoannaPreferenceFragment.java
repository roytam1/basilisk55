...
public class GoannaPreferenceFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPrefsRequest = ((GoannaPreferences)getActivity()).setupPreferences(screen);
        syncPreference = (SyncPreference) findPreference(GoannaPreferences.PREFS_SYNC);
    }
    ...
    private void updateTitle() {
        ...
        final GoannaPreferences activity = (GoannaPreferences) getActivity();
    ...
    private int getResource() {
        ...
        if (resid == 0) {
            ...
            boolean isMultiPane = ((GoannaPreferences) activity).isMultiPane();
