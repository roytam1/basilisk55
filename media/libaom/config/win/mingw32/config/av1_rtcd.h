...
void av1_highbd_inv_txfm_add_16x16_avx2(const tran_low_t *dqcoeff, uint8_t *dst, int stride, const TxfmParam *txfm_param);
...
void av1_highbd_inv_txfm_add_16x32_avx2(const tran_low_t *dqcoeff, uint8_t *dst, int stride, const TxfmParam *txfm_param);
...
void av1_highbd_inv_txfm_add_16x8_avx2(const tran_low_t *dqcoeff, uint8_t *dst, int stride, const TxfmParam *txfm_param);
...
void av1_highbd_inv_txfm_add_32x16_avx2(const tran_low_t *dqcoeff, uint8_t *dst, int stride, const TxfmParam *txfm_param);
...
void av1_highbd_inv_txfm_add_32x8_avx2(const tran_low_t *dqcoeff, uint8_t *dst, int stride, const TxfmParam *txfm_param);
...
void av1_highbd_inv_txfm_add_8x16_avx2(const tran_low_t *dqcoeff, uint8_t *dst, int stride, const TxfmParam *txfm_param);
...
void av1_highbd_inv_txfm_add_8x32_avx2(const tran_low_t *dqcoeff, uint8_t *dst, int stride, const TxfmParam *txfm_param);
...
void av1_highbd_inv_txfm_add_8x8_avx2(const tran_low_t *dqcoeff, uint8_t *dst, int stride, const TxfmParam *txfm_param);
...
static void setup_rtcd_internal(void)
{
    ...
    if (flags & HAS_AVX2) av1_highbd_inv_txfm_add_16x16 = av1_highbd_inv_txfm_add_16x16_avx2;
    ...
    if (flags & HAS_AVX2) av1_highbd_inv_txfm_add_16x32 = av1_highbd_inv_txfm_add_16x32_avx2;
    ...
    if (flags & HAS_AVX2) av1_highbd_inv_txfm_add_16x8 = av1_highbd_inv_txfm_add_16x8_avx2;
    ...
    if (flags & HAS_AVX2) av1_highbd_inv_txfm_add_32x16 = av1_highbd_inv_txfm_add_32x16_avx2;
    ...
    if (flags & HAS_AVX2) av1_highbd_inv_txfm_add_32x8 = av1_highbd_inv_txfm_add_32x8_avx2;
    ...
    if (flags & HAS_AVX2) av1_highbd_inv_txfm_add_8x16 = av1_highbd_inv_txfm_add_8x16_avx2;
    ...
    if (flags & HAS_AVX2) av1_highbd_inv_txfm_add_8x32 = av1_highbd_inv_txfm_add_8x32_avx2;
    ...
    if (flags & HAS_AVX2) av1_highbd_inv_txfm_add_8x8 = av1_highbd_inv_txfm_add_8x8_avx2;
