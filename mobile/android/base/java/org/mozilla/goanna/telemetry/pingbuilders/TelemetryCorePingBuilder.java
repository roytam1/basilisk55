...
package org.mozilla.goanna.telemetry.pingbuilders;
...
import org.mozilla.goanna.telemetry.TelemetryPing;
 ...
 *
 * See https://goanna.readthedocs.org/en/latest/toolkit/components/telemetry/telemetry/core-ping.html
...
public class TelemetryCorePingBuilder extends TelemetryPingBuilder {
    ...
    private void initPayloadConstants(final Context context) {
        ...
        synchronized (this) {
            SharedPreferences prefs = GoannaSharedPrefs.forApp(context);
            final int count = prefs.getInt(GoannaApp.PREFS_FLASH_USAGE, 0);
            payload.put(FLASH_USAGE, count);
            prefs.edit().putInt(GoannaApp.PREFS_FLASH_USAGE, 0).apply();
        }
    }
     ...
     */
    @WorkerThread
    public static Long getProfileCreationDate(final Context context, final GoannaProfile profile) {
