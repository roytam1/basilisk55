...
/**
 * Unit test methods of the GoannaProfile class.
 */
@RunWith(TestRunner.class)
public class TestGoannaProfile {
    ...
    public void setUp() throws IOException {
        ...
        profile = GoannaProfile.get(context, PROFILE_NAME, profileDir);
    ...
    public void assertValidClientId(final String clientId) {
        // This isn't the method we use in the main GoannaProfile code, but it should be equivalent.
    ...
    public void testGetProfileCreationDateTimesFileDoesNotExist() throws Exception {
        ...
        // GoannaProfile because it's final. Instead, we check if the value is at least reasonable.
