...
protected:
  ...
  ParentLayerToScreenMatrix4x4 transformToGoanna;
...
TEST_F(APZHitTestingTester, HitTesting1) {
  ...
  EXPECT_EQ(ParentLayerToScreenMatrix4x4(), transformToGoanna);
  ...
  EXPECT_EQ(ScreenPoint(15, 15), transformToGoanna.TransformPoint(ParentLayerPoint(15, 15)));
  ...
  EXPECT_EQ(ScreenPoint(25, 25), transformToGoanna.TransformPoint(ParentLayerPoint(25, 25)));
  ...
  EXPECT_EQ(ScreenPoint(90, 90), transformToGoanna.TransformPoint(ParentLayerPoint(90, 90)));
...
TEST_F(APZHitTestingTester, HitTesting2) {
  ...
  EXPECT_EQ(ScreenPoint(75, 25), transformToGoanna.TransformPoint(ParentLayerPoint(75, 25)));
  ...
  EXPECT_EQ(ScreenPoint(15, 75), transformToGoanna.TransformPoint(ParentLayerPoint(15, 75)));
  ...
  EXPECT_EQ(ScreenPoint(25, 75), transformToGoanna.TransformPoint(ParentLayerPoint(12.5, 75)));
  ...
  // and transformToGoanna should reapply it
  EXPECT_EQ(ScreenPoint(75, 75), transformToGoanna.TransformPoint(ParentLayerPoint(37.5, 75)));
  ...
  // have been handled.
  EXPECT_EQ(ScreenPoint(75, 75), transformToGoanna.TransformPoint(ParentLayerPoint(75, 75)));
  ...
  EXPECT_EQ(ScreenPoint(25, 25), transformToGoanna.TransformPoint(ParentLayerPoint(12.5, 75)));
  ...
  // transformToApzc doesn't unapply the root's own async transform
  EXPECT_EQ(ParentLayerPoint(75, 75), transformToApzc.TransformPoint(ScreenPoint(75, 75)));
  // transformToGoanna unapplies the full async transform of -100 pixels
  EXPECT_EQ(ScreenPoint(75, 75), transformToGoanna.TransformPoint(ParentLayerPoint(75, 75)));
