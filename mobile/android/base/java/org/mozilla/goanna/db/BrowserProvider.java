...
import org.mozilla.goanna.db.BrowserContract.Highlights;
...
public class BrowserProvider extends SharedBrowserDatabaseProvider {
    public static final String ACTION_SHRINK_MEMORY = "org.mozilla.goanna.db.intent.action.SHRINK_MEMORY";
    ...
    private Cursor getTopSites(final Uri uri) {
        ...
        final SuggestedSites suggestedSites = BrowserDB.from(GoannaProfile.get(
