...
public class GoannaAccessibility {
    ...
    private static GoannaBundle sHoverEnter;
    ...
    public static void updateAccessibilitySettings (final Context context) {
        new UIAsyncTask.WithoutParams<Void>(ThreadUtils.getBackgroundHandler()) {
                ...
                public Void doInBackground() {
                    ...
                    GoannaAppShell.notifyObservers("Accessibility:Settings", ret.toString());
                    return null;
                }
                ...
                public void onPostExecute(Void args) {
                    ...
                    goannaInterface.setAccessibilityEnabled(sEnabled);
                }
            }.execute();
    }

    private static void populateEventFromJSON (AccessibilityEvent event, GoannaBundle message) {
    ...
    private static void sendDirectAccessibilityEvent(int eventType, GoannaBundle message) {
    ...
    public static void sendAccessibilityEvent(final GoannaBundle message) {
        if (!sEnabled)
            return;
    ...
    public static void sendAccessibilityEvent(final GoannaBundle message, final int eventType) {
        if (!sEnabled)
            return;
        ...
        if (Build.VERSION.SDK_INT < 16) {
            ...
            final View view = GoannaAppShell.getLayerView();
            if (view == null)
                return;
            ...
            final GoannaBundle bounds = message.getBundle("bounds");
            if (bounds != null) {
            ...
            final GoannaBundle braille = message.getBundle("brailleOutput");
            if (braille != null) {
            ...
            ThreadUtils.postToUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        event.setPackageName(GoannaAppShell.getApplicationContext().getPackageName());
                        event.setClassName(GoannaAccessibility.class.getName());
    ...
    public static void setDelegate(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            view.setAccessibilityDelegate(new GoannaAccessibilityDelegate());
    ...
    public static void onLayerViewFocusChanged(boolean gainFocus) {
        if (sEnabled)
            GoannaAppShell.notifyObservers("Accessibility:Focus", gainFocus ? "true" : "false");
    }
                ...
                mAccessibilityNodeProvider = new AccessibilityNodeProvider() {
                        ...
                        public AccessibilityNodeInfo createAccessibilityNodeInfo(int virtualDescendantId) {
                            ...
                            default:
                                ...
                                info.setPackageName(GoannaAppShell.getApplicationContext().getPackageName());
                        ...
                        public boolean performAction (int virtualViewId, int action, Bundle arguments) {
                            if (action == AccessibilityNodeInfo.ACTION_ACCESSIBILITY_FOCUS) {
                                ...
                                if (virtualViewId == VIRTUAL_CURSOR_POSITION && sHoverEnter != null) {
                                    GoannaAccessibility.sendAccessibilityEvent(sHoverEnter, AccessibilityEvent.TYPE_VIEW_ACCESSIBILITY_FOCUSED);
                                } else {
                                    GoannaAppShell.notifyObservers("Accessibility:Focus", "true");
                                }
                                return true;
                            } else if (action == AccessibilityNodeInfo.ACTION_CLICK && virtualViewId == VIRTUAL_CURSOR_POSITION) {
                                GoannaAppShell.notifyObservers("Accessibility:ActivateObject", null);
                                return true;
                            } else if (action == AccessibilityNodeInfo.ACTION_LONG_CLICK && virtualViewId == VIRTUAL_CURSOR_POSITION) {
                                GoannaAppShell.notifyObservers("Accessibility:LongPress", null);
                                return true;
                            } else if (action == AccessibilityNodeInfo.ACTION_SCROLL_FORWARD && virtualViewId == VIRTUAL_CURSOR_POSITION) {
                                GoannaAppShell.notifyObservers("Accessibility:ScrollForward", null);
                                return true;
                            } else if (action == AccessibilityNodeInfo.ACTION_SCROLL_BACKWARD && virtualViewId == VIRTUAL_CURSOR_POSITION) {
                                GoannaAppShell.notifyObservers("Accessibility:ScrollBackward", null);
                                return true;
                                ...
                                GoannaAppShell.notifyObservers("Accessibility:NextObject", traversalRule);
                                return true;
                                ...
                                GoannaAppShell.notifyObservers("Accessibility:PreviousObject", traversalRule);
                                return true;
                                ...
                                if (granularity <= BRAILLE_CLICK_BASE_INDEX) {
                                    ...
                                    GoannaAppShell.notifyObservers("Accessibility:ActivateObject", activationData.toString());
                                    ...
                                    GoannaAppShell.notifyObservers("Accessibility:MoveByGranularity", movementData.toString());
                                }
                                return true;
