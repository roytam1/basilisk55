...
public class PostUpdateHandler extends BrowserAppDelegateWithReference {
    ...
    public void onStart(final BrowserApp browserApp) {
        ThreadUtils.postToBackgroundThread(new Runnable() {
            ...
            public void run() {
                ...
                if (!AppConstants.MOZ_APP_BUILDID.equals(prefs.getString(GoannaPreferences.PREFS_APP_UPDATE_LAST_BUILD_ID, null))) {
                    Log.d(LOGTAG, "Build ID changed since last start: '" + AppConstants.MOZ_APP_BUILDID + "', '" + prefs.getString(GoannaPreferences.PREFS_APP_UPDATE_LAST_BUILD_ID, null) + "'");
    ...
    private void copyFeaturesFromAPK(BrowserApp browserApp) {
        ...
        prefs.edit().putString(GoannaPreferences.PREFS_APP_UPDATE_LAST_BUILD_ID, AppConstants.MOZ_APP_BUILDID).apply();
    }
