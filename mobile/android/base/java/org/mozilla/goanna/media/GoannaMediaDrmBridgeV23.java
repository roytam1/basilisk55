...
@TargetApi(M)
public class GoannaMediaDrmBridgeV23 extends GoannaMediaDrmBridgeV21 {
    private static final boolean DEBUG = false;

    GoannaMediaDrmBridgeV23(String keySystem) throws Exception {
        super(keySystem);
        if (DEBUG) Log.d(LOGTAG, "GoannaMediaDrmBridgeV23 ctor");
