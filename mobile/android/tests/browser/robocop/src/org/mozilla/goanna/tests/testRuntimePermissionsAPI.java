...
public class testRuntimePermissionsAPI extends JavascriptTest implements BundleEventListener {
    ...
    public void setUp() throws Exception {
        ...
        GoannaApp.getEventDispatcher().registerUiThreadListener(this, "RuntimePermissions:Prompt");
    }
    ...
    public void tearDown() throws Exception {
        ...
        GoannaApp.getEventDispatcher().unregisterUiThreadListener(this, "RuntimePermissions:Prompt");
    }
