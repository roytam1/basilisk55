...
public class DynamicToolbarAnimator {
    private static final String LOGTAG = "GoannaDynamicToolbarAnimator";
     ...
     * GoannaLayerClient's viewport metrics, and the Goanna one is stored here.
    ...
    public DynamicToolbarAnimator(GoannaLayerClient aTarget) {
        mTarget = aTarget;
