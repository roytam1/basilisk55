...
public interface Actions {
     ...
     */
    void sendGlobalEvent(String event, GoannaBundle data);

    /**
     * Sends an event to the GoannaApp-specific EventDispatcher instance.
     *
     * @param event The event type
     * @param data Data associated with the event
     */
    void sendWindowEvent(String event, GoannaBundle data);
