...
package org.mozilla.goanna.text;
...
public class TextAction {
    private static final String LOGTAG = "GoannaTextAction";
    ...
    public static List<TextAction> fromEventMessage(final GoannaBundle message) {
        final List<TextAction> actions = new ArrayList<>();
        final GoannaBundle[] array = message.getBundleArray("actions");

        for (int i = 0; i < array.length; i++) {
            final GoannaBundle object = array[i];
