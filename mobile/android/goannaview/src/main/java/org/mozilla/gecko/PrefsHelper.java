...
public final class PrefsHelper {
    ...
    public static void getPrefs(final String[] prefNames, final PrefHandler callback) {
        if (GoannaThread.isStateAtLeast(GoannaThread.State.PROFILE_READY)) {
            ...
            GoannaThread.queueNativeCallUntil(
                    GoannaThread.State.PROFILE_READY, PrefsHelper.class, "nativeGetPrefs",
    ...
    public static void setPref(final String pref, final Object value, final boolean flush) {
        ...
        if (GoannaThread.isStateAtLeast(GoannaThread.State.PROFILE_READY)) {
            ...
            GoannaThread.queueNativeCallUntil(
                    GoannaThread.State.PROFILE_READY, PrefsHelper.class, "nativeSetPref",
    ...
    public synchronized static void addObserver(final String[] prefNames,
        ...
        if (GoannaThread.isStateAtLeast(GoannaThread.State.PROFILE_READY)) {
            ...
            GoannaThread.queueNativeCallUntil(
                    GoannaThread.State.PROFILE_READY, PrefsHelper.class, "nativeAddObserver",
    ...
    public synchronized static void removeObserver(final PrefHandler handler) {
        ...
        if (GoannaThread.isStateAtLeast(GoannaThread.State.PROFILE_READY)) {
            ...
            GoannaThread.queueNativeCallUntil(
                    GoannaThread.State.PROFILE_READY, PrefsHelper.class, "nativeRemoveObserver",
    ...
    private static void callPrefHandler(final PrefHandler handler, int type, final String pref,
        ...
        // Some Goanna preferences use integers or strings to reference state instead of
