...
import org.mozilla.goanna.activitystream.ActivityStream;
import org.mozilla.goanna.adjust.AdjustBrowserAppDelegate;
...
import org.mozilla.goanna.cleanup.FileCleanupController;
...
import org.mozilla.goanna.delegates.OfflineTabStatusDelegate;
import org.mozilla.goanna.delegates.ScreenshotDelegate;
import org.mozilla.goanna.distribution.Distribution;
import org.mozilla.goanna.distribution.DistributionStoreCallback;
import org.mozilla.goanna.distribution.PartnerBrowserCustomizationsClient;
import org.mozilla.goanna.dlc.DownloadContentService;
import org.mozilla.goanna.icons.IconsHelper;
import org.mozilla.goanna.icons.decoders.IconDirectoryEntry;
import org.mozilla.goanna.icons.decoders.FaviconDecoder;
import org.mozilla.goanna.feeds.ContentNotificationsDelegate;
import org.mozilla.goanna.feeds.FeedService;
import org.mozilla.goanna.firstrun.FirstrunAnimationContainer;
import org.mozilla.goanna.gfx.DynamicToolbarAnimator;
import org.mozilla.goanna.gfx.DynamicToolbarAnimator.PinReason;
...
import org.mozilla.goanna.home.HomeConfigPrefsBackend;
...
import org.mozilla.goanna.icons.IconCallback;
import org.mozilla.goanna.icons.IconResponse;
import org.mozilla.goanna.icons.Icons;
import org.mozilla.goanna.javaaddons.JavaAddonManager;
import org.mozilla.goanna.media.VideoPlayer;
...
import org.mozilla.goanna.promotion.AddToHomeScreenPromotion;
import org.mozilla.goanna.delegates.BookmarkStateChangeDelegate;
import org.mozilla.goanna.promotion.ReaderViewBookmarkPromotion;
import org.mozilla.goanna.prompts.Prompt;
import org.mozilla.goanna.reader.SavedReaderViewHelper;
import org.mozilla.goanna.reader.ReaderModeUtils;
import org.mozilla.goanna.reader.ReadingListHelper;
import org.mozilla.goanna.restrictions.Restrictable;
import org.mozilla.goanna.restrictions.RestrictedProfileConfiguration;
...
import org.mozilla.goanna.tabqueue.TabQueueHelper;
import org.mozilla.goanna.tabqueue.TabQueuePrompt;
...
import org.mozilla.goanna.telemetry.TelemetryUploadService;
import org.mozilla.goanna.telemetry.TelemetryCorePingDelegate;
import org.mozilla.goanna.telemetry.measurements.SearchCountMeasurements;
...
import org.mozilla.goanna.trackingprotection.TrackingProtectionPrompt;
import org.mozilla.goanna.updater.PostUpdateHandler;
...
import org.mozilla.goanna.util.ContextUtils;
...
public class BrowserApp extends GoannaApp
    ...
    private static final int GOANNA_TOOLS_MENU = -1;
    ...
    public void onTabChanged(Tab tab, TabEvents msg, String data) {
        if (tab == null) {
            ...
            if (selectedTab != null) {
                ...
                // might wait for an event coming from Goanna and this can take several seconds. (Bug 1283627)
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GoannaLoader.loadMozGlue(appContext);
        if (!HardwareUtils.isSupportedSystem() || !GoannaLoader.neonCompatible()) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (BrowserApp.this.isFinishing()) {
                            // TabHistoryController is rather slow - and involves calling into Goanna
    ...
    private void conditionallyNotifyEOL() {
        ...
        try {
            ...
            if (!prefs.contains(EOL_NOTIFIED)) {
                ...
                GoannaSharedPrefs.forProfile(this)
                                .edit()
    ...
    public void onStart() {
        ...
        ThreadUtils.postToBackgroundThread(new Runnable() {
            ...
            public void run() {
                ...
                final SharedPreferences sharedPrefs = GoannaSharedPrefs.forProfileName(BrowserApp.this, profile.getName());
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.subscribe) {
            ...
            if (tab != null && tab.hasFeeds()) {
                ...
                GoannaAppShell.notifyObservers("Feeds:Subscribe", args.toString());
            }
            return true;
        }
        ...
        if (itemId == R.id.add_search_engine) {
            ...
            if (tab != null && tab.hasOpenSearch()) {
                ...
                GoannaAppShell.notifyObservers("SearchEngines:Add", args.toString());
            }
            return true;
        }
        ...
        if (itemId == R.id.add_to_launcher) {
            ...
            ThreadUtils.postToBackgroundThread(new Runnable() {
                @Override
                public void run() {
                    GoannaAppShell.createShortcut(title, url);
                }
            });
    ...
    public void onDestroy() {
        ...
        if (!isFinishing()) {
            // GoannaApp was not intentionally destroyed, so keep our process alive.
            return;
        }

        // Wait for Goanna to handle our pause event sent in onPause.
    ...
    public void handleMessage(final String event, final GoannaBundle message,
        ...
        switch (event) {
            case "Goanna:Ready":
                EventDispatcher.getInstance().registerUiThreadListener(this, "Goanna:DelayedStartup");
            ...
            case "Goanna:DelayedStartup":
                EventDispatcher.getInstance().unregisterUiThreadListener(this, "Goanna:DelayedStartup");
            ...
            case "Search:Keyword":
                ...
                recordSearch(GoannaSharedPrefs.forProfile(this), message.getString("identifier"),
            ...
            case "CharEncoding:Data":
                final GoannaBundle[] charsets = message.getBundleArray("charsets");
                ...
                for (int i = 0; i < charsets.length; i++) {
                    final GoannaBundle charset = charsets[i];
                ...
                dialogBuilder.setSingleChoiceItems(titleArray, selected,
                        new AlertDialog.OnClickListener() {
                            ...
                            public void onClick(final DialogInterface dialog, final int which) {
                                GoannaAppShell.notifyObservers("CharEncoding:Set", codeArray[which]);
                                dialog.dismiss();
                            }
                        });
            ...
            case "Settings:Show":
                ...
                final String resource = message.getString(GoannaPreferences.INTENT_EXTRA_RESOURCES);
            ...
            case "Website:AppInstalled":
                ...
                final Bitmap icon = FaviconDecoder
                    ...
                    .getBestBitmap(GoannaAppShell.getPreferredIconSize());
    ...
    public void showTrackingProtectionPromptIfApplicable() {
        ...
        final boolean hasTrackingProtectionPromptBeShownBefore = prefs.getBoolean(GoannaPreferences.PREFS_TRACKING_PROTECTION_PROMPT_SHOWN, false);

        if (hasTrackingProtectionPromptBeShownBefore) {
            return;
        }

        prefs.edit().putBoolean(GoannaPreferences.PREFS_TRACKING_PROTECTION_PROMPT_SHOWN, true).apply();
    ...
    */
    ...
    public String getHomepage() {
        final SharedPreferences preferences = GoannaSharedPrefs.forProfile(this);
        final String homepagePreference = preferences.getString(GoannaPreferences.PREFS_HOMEPAGE, null);

        final boolean readFromPartnerProvider = preferences.getBoolean(
                GoannaPreferences.PREFS_READ_PARTNER_CUSTOMIZATIONS_PROVIDER, false);
        ...
        final String homepagePrevious = preferences.getString(GoannaPreferences.PREFS_HOMEPAGE_PARTNER_COPY, null);
        ...
        if (!homepagePartner.equals(homepagePrevious)) {
            ...
            preferences.edit()
                    .putString(GoannaPreferences.PREFS_HOMEPAGE, homepagePartner)
                    .putString(GoannaPreferences.PREFS_HOMEPAGE_PARTNER_COPY, homepagePartner)
                    .apply();
        }
    ...
    private void loadUrlOrKeywordSearch(final String url) {
        ...
        final SharedPreferences sharedPrefs = GoannaSharedPrefs.forProfile(this);
        final BrowserDB db = BrowserDB.from(getProfile());
        ThreadUtils.postToBackgroundThread(new Runnable() {
            @Override
            public void run() {
    ...
    private void showFirstrunPager() {
        if (Experiments.isInExperimentLocal(getContext(), Experiments.ONBOARDING3_A)) {
            ...
            GoannaSharedPrefs.forProfile(getContext()).edit().putString(Experiments.PREF_ONBOARDING_VERSION, Experiments.ONBOARDING3_A).apply();
    ...
    private void addAddonMenuItemToMenu(final Menu menu, final MenuItemInfo info) {
        ...
        if (info.parent == 0) {
            destination = menu;
        } else if (info.parent == GOANNA_TOOLS_MENU) {
        ...
        item.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                GoannaAppShell.notifyObservers("Menu:Clicked", Integer.toString(info.id - ADDON_MENU_OFFSET));
                return true;
            }
        });
    ...
    private void updateAddonMenuItem(int id, final GoannaBundle options) {
    ...
    public void openOptionsMenu() {
        ...
        if (mMenu instanceof GoannaMenu) {
            ((GoannaMenu) mMenu).setSelection(0);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.save_as_pdf) {
            ...
            GoannaAppShell.notifyObservers("SaveAs:PDF", null);
            return true;
        }
        ...
        if (itemId == R.id.char_encoding) {
            GoannaAppShell.notifyObservers("CharEncoding:Get", null);
            return true;
        }
        ...
        if (itemId == R.id.desktop_mode) {
            ...
            GoannaAppShell.notifyObservers("DesktopMode:Change", args.toString());
            return true;
        }
        ...
        final Prompt ps = new Prompt(this, new Prompt.PromptCallback() {
            ...
            public void onPromptFinished(final GoannaBundle result) {
                ...
                if (type == GuestModeDialog.ENTERING) {
                    GoannaProfile.enterGuestMode(context);
                } else {
                    GoannaProfile.leaveGuestMode(context);
    ...
    protected void onNewIntent(Intent externalIntent) {
        ...
        try {
            ...
            if (launchCount < FEEDBACK_LAUNCH_COUNT) {
                ...
                if (launchCount == FEEDBACK_LAUNCH_COUNT) {
                    GoannaAppShell.notifyObservers("Feedback:Show", null);
                }
            }
        } finally {
            StrictMode.setThreadPolicy(savedPolicy);
    ...
    public void openUrls(List<String> urls) {
        try {
            ...
            GoannaAppShell.notifyObservers("Tabs:OpenMultiple", object.toString());
        } catch (JSONException e) {
    ...
    public void onSearch(SearchEngine engine, final String text, final TelemetryContract.Method method) {
        ...
        recordSearch(GoannaSharedPrefs.forProfile(this), identifierToRecord, method);
    ...
    protected void recordStartupActionTelemetry(final String passedURL, final String action) {
        ...
        if (GoannaProfile.get(this).inGuestMode()) {
