...
public class FirstrunPagerConfig {
   ...
   public static List<FirstrunPanelConfig> getDefault(Context context) {
        ...
        if (Experiments.isInExperimentLocal(context, Experiments.ONBOARDING3_B)) {
            ...
            GoannaSharedPrefs.forProfile(context).edit().putString(Experiments.PREF_ONBOARDING_VERSION, Experiments.ONBOARDING3_B).apply();
            ...
            GoannaSharedPrefs.forProfile(context).edit().putString(Experiments.PREF_ONBOARDING_VERSION, Experiments.ONBOARDING3_C).apply();
        } else {
