...
public class TestIconRequestBuilder {
    ...
    public void testForLauncherIcon() {
        // This code will call into GoannaAppShell to determine the launcher icon size for this configuration
        GoannaAppShell.setApplicationContext(RuntimeEnvironment.application);
