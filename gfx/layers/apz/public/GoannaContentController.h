...
public:
   ...
   * on the GoannaContentController. For ChromeProcessController it is the
   * Goanna main thread, while for RemoteContentController it is the compositor
   ...
   * method to notify goanna of the pinch gesture, and allow it to deal with it
