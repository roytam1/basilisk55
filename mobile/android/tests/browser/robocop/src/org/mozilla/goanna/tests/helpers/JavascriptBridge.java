 ...
 *
 * Supported argument types include int, double, boolean, String, and GoannaBundle. Note
...
public final class JavascriptBridge {
    ...
    private GoannaBundle mSavedAsyncMessage;
    ...
    public JavascriptBridge(final Object target) {
        ...
        mExpecter = sActions.expectGlobalEvent(Actions.EventType.GOANNA, EVENT_TYPE);
     ...
     *             values allowed by GoannaBundle.
     */
    ...
    private MessageStatus maybeProcessPendingMessage() {
        // We're on the test thread.
        final GoannaBundle message = mExpecter.blockForBundleWithTimeout(0);
        if (message != null) {
    ...
    private void sendMessage(final String innerType, final String method, final Object[] args) {
        ...
        final GoannaBundle bundleArgs = new GoannaBundle();
        if (args == null) {
    ...
    private MessageStatus processMessage(GoannaBundle message) {
        final String type;
        final String methodName;
        final GoannaBundle argsArray;
        final Object[] args;
        ...
        switch (type) {
            ...
            case "async-call":
                ...
                if ("async-call".equals(type)) {
                    ...
                    // mSavedAsyncMessage.
                    final GoannaBundle newSavedMessage =
    ...
    private void putInBundle(final GoannaBundle bundle, final String key, final Object value) {
        if (value == null) {
            ...
            bundle.putBundle(key, (GoannaBundle) value);
        } else if (value instanceof GoannaBundle[]) {
            bundle.putBundleArray(key, (GoannaBundle[]) value);
        } else {
            throw new UnsupportedOperationException();
        }
    }
