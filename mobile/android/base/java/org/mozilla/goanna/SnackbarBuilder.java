...
public class SnackbarBuilder {
    ...
    public static final String LOGTAG = "GoannaSnackbarBuilder";
    ...
    /**
     * @param object Populate the builder with data from a Goanna Snackbar:Show event.
     */
    public SnackbarBuilder fromEvent(final GoannaBundle object) {
        ...
        GoannaBundle actionObject = object.getBundle("action");
    ...
    private static View findBestParentView(Activity activity) {
        if (activity instanceof GoannaApp) {
