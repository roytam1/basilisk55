...
public class Experiments {
    private static final String LOGTAG = "GoannaExperiments";
    ...
    public static List<String> getActiveExperiments(Context c) {
        ...
        final String onboardingExperiment = GoannaSharedPrefs.forProfile(c).getString(Experiments.PREF_ONBOARDING_VERSION, null);
