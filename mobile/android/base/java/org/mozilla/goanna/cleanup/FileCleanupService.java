...
package org.mozilla.goanna.cleanup;
...
public class FileCleanupService extends IntentService {
    private static final String LOGTAG = "Goanna" + FileCleanupService.class.getSimpleName();
    private static final String WORKER_THREAD_NAME = LOGTAG + "Worker";

    public static final String ACTION_DELETE_FILES = "org.mozilla.goanna.intent.action.DELETE_FILES";
    public static final String EXTRA_FILE_PATHS_TO_DELETE = "org.mozilla.goanna.file_paths_to_delete";
