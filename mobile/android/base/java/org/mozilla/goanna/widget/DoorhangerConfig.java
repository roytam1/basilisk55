...
import org.mozilla.goanna.widget.DoorHanger.Type;
...
public class DoorhangerConfig {
    ...
    public void setOptions(GoannaBundle options) {
        this.options = options;

        // Set link if there is a link provided in options.
        final GoannaBundle linkObj = options.getBundle("link");
        if (linkObj != null) {
            setLink(linkObj.getString("label"), linkObj.getString("url"));
        }
    }

    public GoannaBundle getOptions() {
        return options;
    }
