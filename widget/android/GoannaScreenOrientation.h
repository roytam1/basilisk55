...
#ifndef GoannaScreenOrientation_h
#define GoannaScreenOrientation_h
...
class GoannaScreenOrientation final
    : public java::GoannaScreenOrientation::Natives<GoannaScreenOrientation>
{
    GoannaScreenOrientation() = delete;
...
#endif // GoannaScreenOrientation_h
