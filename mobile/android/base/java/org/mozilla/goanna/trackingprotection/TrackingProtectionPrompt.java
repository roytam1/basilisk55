...
package org.mozilla.goanna.trackingprotection;
...
public class TrackingProtectionPrompt extends Locales.LocaleAwareActivity {
        public static final String LOGTAG = "Goanna" + TrackingProtectionPrompt.class.getSimpleName();
        ...
        private void showPrompt() {
            ...
            findViewById(R.id.link_text).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    slideOut();
                    final Intent settingsIntent = new Intent(TrackingProtectionPrompt.this, GoannaPreferences.class);
                    GoannaPreferences.setResourceToOpen(settingsIntent, "preferences_privacy");
