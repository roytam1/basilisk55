...
/* package-local */ class GlobalPageMetadata implements BundleEventListener {
    private static final String LOG_TAG = "GoannaGlobalPageMetadata";
    ...
    private final Map<String, GoannaBundle> queuedMetadata =
            Collections.synchronizedMap(new LimitedLinkedHashMap<String, GoannaBundle>());
    ...
    /*package-local */ void doAddOrQueue(BrowserDB db, ContentProviderClient contentProviderClient, String uri, boolean hasImage, @NonNull String metadataJSON) {
        ...
        GoannaBundle bundledMetadata = new GoannaBundle();
    ...
    public void handleMessage(String event, GoannaBundle message, EventCallback callback) {
        ...
        final GoannaBundle bundledMetadata;
    ...
    private void insertMetadataBundleForUri(String uri, GoannaBundle bundledMetadata) {
        ...
        final ContentProviderClient contentProviderClient = GoannaAppShell.getApplicationContext()
                .getContentResolver()
        ...
        try {
            add(
                    BrowserDB.from(GoannaThread.getActiveProfile()),
