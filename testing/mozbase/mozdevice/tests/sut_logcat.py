...
class TestLogCat(unittest.TestCase):
    ...
    def test_getLogcat(self):
        ...
        logcat_output = (
            ...
            "07-17 00:51:10.547 D/GoannaHealthRec( 3253): Initializing profile cache.\r\n"
            "07-17 00:51:10.607 D/GoannaHealthRec( 3253): Looking for /data/data/org.mozilla.fennec/files/mozilla/c09kfhne.default/times.json\r\n"  # noqa
            "07-17 00:51:10.637 D/GoannaHealthRec( 3253): Using times.json for profile creation time.\r\n"  # noqa
            "07-17 00:51:10.707 D/GoannaHealthRec( 3253): Incorporating environment: times.json profile creation = 1374026758604\r\n"  # noqa
            "07-17 00:51:10.507 D/GoannaHealthRec( 3253): Requested prefs.\r\n"
