...
import static org.mozilla.goanna.tests.helpers.AssertionHelper.fAssertSame;
...
public class GoannaViewComponent extends BaseComponent {
    ...
    public static abstract class InputConnectionTest {
        ...
        protected void processInputConnectionEvents() {
            ...
            // Adapted from GoannaThread.pumpMessageLoop.
        ...
        /**
         * Processes pending events on the Goanna thread before returning.
         * Must be called on the input connection thread during a test.
         */
        protected void processGoannaEvents() {
            fAssertSame("Should be called on input connection thread",
                    Looper.myLooper(), inputConnectionHandler.getLooper());
        ...
        private static void assertText(final String message,
                                       ...
                                       final String actual) {
            // In an HTML editor, Goanna may insert an additional element that show up as a
