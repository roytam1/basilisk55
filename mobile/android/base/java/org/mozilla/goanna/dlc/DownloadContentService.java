...
package org.mozilla.goanna.dlc;

import org.mozilla.goanna.AppConstants;
import org.mozilla.goanna.GoannaAppShell;
import org.mozilla.goanna.dlc.catalog.DownloadContent;
import org.mozilla.goanna.dlc.catalog.DownloadContentCatalog;
...
public class DownloadContentService extends IntentService {
    private static final String LOGTAG = "GoannaDLCService";
            ...
            case ACTION_DOWNLOAD_CONTENT:
                action = new DownloadAction(new DownloadAction.Callback() {
                    ...
                    public void onContentDownloaded(DownloadContent content) {
                        if (content.isFont()) {
                            GoannaAppShell.notifyObservers("Fonts:Reload", "");
                        }
                    }
                });
                break;
