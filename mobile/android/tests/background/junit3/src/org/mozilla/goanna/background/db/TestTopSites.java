...
public class TestTopSites extends ActivityInstrumentationTestCase2<Activity> {
    ...
    public void setUp() {
        ...
        BrowserDB.from(GoannaProfile.get(mContext, Constants.DEFAULT_PROFILE)).setSuggestedSites(mSuggestedSites);
    }

    @Override
    public void tearDown() {
        BrowserDB.from(GoannaProfile.get(mContext, Constants.DEFAULT_PROFILE)).setSuggestedSites(null);
    }
