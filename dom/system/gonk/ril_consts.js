...
this.GOANNA_ERROR_SIM_PIN2 = "SimPin2";
this.GOANNA_ERROR_SIM_PUK2 = "SimPuk2";
this.GOANNA_ERROR_REQUEST_NOT_SUPPORTED = "RequestNotSupported";
this.GOANNA_ERROR_CANCELLED = "Cancelled";
this.GOANNA_ERROR_OP_NOT_ALLOWED_DURING_VOICE_CALL = "OpNotAllowedDuringVoiceCall";
this.GOANNA_ERROR_OP_NOT_ALLOWED_BEFORE_REG_TO_NW = "OpNotAllowedBeforeRegToNw";
this.GOANNA_ERROR_SMS_SEND_FAIL_RETRY = "SmsSendFailRetry";
this.GOANNA_ERROR_SIM_ABSENT = "SimAbsent";
this.GOANNA_ERROR_SUBSCRIPTION_NOT_AVAILABLE = "SubscriptionNotAvailable";
this.GOANNA_ERROR_MODE_NOT_SUPPORTED = "ModeNotSupported";
this.GOANNA_ERROR_FDN_CHECK_FAILURE = "FdnCheckFailure";
this.GOANNA_ERROR_ILLEGAL_SIM_OR_ME = "IllegalSIMorME";
this.GOANNA_ERROR_MISSING_RESOURCE = "MissingResource";
this.GOANNA_ERROR_NO_SUCH_ELEMENT = "NoSuchElement";
this.GOANNA_ERROR_INVALID_PARAMETER = "InvalidParameter";
this.GOANNA_ERROR_UNSPECIFIED_ERROR = "UnspecifiedError";
...
RIL_ERROR_TO_GOANNA_ERROR[ERROR_SIM_PIN2] = GOANNA_ERROR_SIM_PIN2;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_SIM_PUK2] = GOANNA_ERROR_SIM_PUK2;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_REQUEST_NOT_SUPPORTED] = GOANNA_ERROR_REQUEST_NOT_SUPPORTED;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_CANCELLED] = GOANNA_ERROR_CANCELLED;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_OP_NOT_ALLOWED_DURING_VOICE_CALL] = GOANNA_ERROR_OP_NOT_ALLOWED_DURING_VOICE_CALL;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_OP_NOT_ALLOWED_BEFORE_REG_TO_NW] = GOANNA_ERROR_OP_NOT_ALLOWED_BEFORE_REG_TO_NW;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_SMS_SEND_FAIL_RETRY] = GOANNA_ERROR_SMS_SEND_FAIL_RETRY;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_SIM_ABSENT] = GOANNA_ERROR_SIM_ABSENT;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_SUBSCRIPTION_NOT_AVAILABLE] = GOANNA_ERROR_SUBSCRIPTION_NOT_AVAILABLE;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_MODE_NOT_SUPPORTED] = GOANNA_ERROR_MODE_NOT_SUPPORTED;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_FDN_CHECK_FAILURE] = GOANNA_ERROR_FDN_CHECK_FAILURE;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_ILLEGAL_SIM_OR_ME] = GOANNA_ERROR_ILLEGAL_SIM_OR_ME;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_MISSING_RESOURCE] = GOANNA_ERROR_MISSING_RESOURCE;
RIL_ERROR_TO_GOANNA_ERROR[ERROR_NO_SUCH_ELEMENT] = GOANNA_ERROR_NO_SUCH_ELEMENT;
...
this.GOANNA_QAN_STATE_AVAILABLE = "available";
this.GOANNA_QAN_STATE_CONNECTED = "connected";
this.GOANNA_QAN_STATE_FORBIDDEN = "forbidden";

this.RIL_QAN_STATE_TO_GOANNA_STATE = {};
this.RIL_QAN_STATE_TO_GOANNA_STATE[this.QAN_STATE_UNKNOWN]   = this.GOANNA_QAN_STATE_UNKNOWN;
this.RIL_QAN_STATE_TO_GOANNA_STATE[this.QAN_STATE_AVAILABLE] = this.GOANNA_QAN_STATE_AVAILABLE;
this.RIL_QAN_STATE_TO_GOANNA_STATE[this.QAN_STATE_CURRENT]   = this.GOANNA_QAN_STATE_CONNECTED;
this.RIL_QAN_STATE_TO_GOANNA_STATE[this.QAN_STATE_FORBIDDEN] = this.GOANNA_QAN_STATE_FORBIDDEN;
...
this.GOANNA_PREFERRED_NETWORK_TYPE_LTE_CDMA_EVDO = "lte/cdma/evdo";
this.GOANNA_PREFERRED_NETWORK_TYPE_LTE_WCDMA_GSM = "lte/wcdma/gsm";
this.GOANNA_PREFERRED_NETWORK_TYPE_LTE_WCDMA = "lte/wcdma";
this.GOANNA_PREFERRED_NETWORK_TYPE_LTE_WCDMA_GSM_CDMA_EVDO = "lte/wcdma/gsm/cdma/evdo";
this.GOANNA_PREFERRED_NETWORK_TYPE_LTE_ONLY = "lte";
this.RIL_PREFERRED_NETWORK_TYPE_TO_GOANNA = [
  ...
  GOANNA_PREFERRED_NETWORK_TYPE_LTE_CDMA_EVDO,
  GOANNA_PREFERRED_NETWORK_TYPE_LTE_WCDMA_GSM,
  GOANNA_PREFERRED_NETWORK_TYPE_LTE_WCDMA_GSM_CDMA_EVDO,
  GOANNA_PREFERRED_NETWORK_TYPE_LTE_ONLY,
  GOANNA_PREFERRED_NETWORK_TYPE_LTE_WCDMA
];

this.GOANNA_SUPPORTED_NETWORK_TYPES_DEFAULT = "gsm,wcdma";
// Index-item pair must be in sync with nsIMobileConnection.MOBILE_NETWORK_TYPE_*
this.GOANNA_SUPPORTED_NETWORK_TYPES = [
  "gsm",
  "wcdma",
  "cdma",
  "evdo",
...
//       ril.h and TS 27.007, clause 8.65 for GOANNA_CARDLOCK_PCK.
...
this.GOANNA_IMG_CODING_SCHEME_BASIC              = "basic";
this.GOANNA_IMG_CODING_SCHEME_COLOR              = "color";
this.GOANNA_IMG_CODING_SCHEME_COLOR_TRANSPARENCY = "color-transparency";

this.ICC_IMG_CODING_SCHEME_TO_GOANNA = {};
ICC_IMG_CODING_SCHEME_TO_GOANNA[ICC_IMG_CODING_SCHEME_BASIC] = GOANNA_IMG_CODING_SCHEME_BASIC;
ICC_IMG_CODING_SCHEME_TO_GOANNA[ICC_IMG_CODING_SCHEME_COLOR] = GOANNA_IMG_CODING_SCHEME_COLOR;
ICC_IMG_CODING_SCHEME_TO_GOANNA[ICC_IMG_CODING_SCHEME_COLOR_TRANSPARENCY] = GOANNA_IMG_CODING_SCHEME_COLOR_TRANSPARENCY;
...
this.CONTACT_ERR_REQUEST_NOT_SUPPORTED = GOANNA_ERROR_REQUEST_NOT_SUPPORTED;
...
this.GOANNA_DATACALL_PDP_TYPE_IP = "IP";
this.GOANNA_DATACALL_PDP_TYPE_IPV4V6 = "IPV4V6";
this.GOANNA_DATACALL_PDP_TYPE_IPV6 = "IPV6";
this.GOANNA_DATACALL_PDP_TYPE_DEFAULT = GOANNA_DATACALL_PDP_TYPE_IP;
this.RIL_DATACALL_PDP_TYPES = [
  GOANNA_DATACALL_PDP_TYPE_IP,
  GOANNA_DATACALL_PDP_TYPE_IPV4V6,
  GOANNA_DATACALL_PDP_TYPE_IPV6,
];
...
this.GOANNA_RADIOSTATE_UNKNOWN   = -1;
this.GOANNA_RADIOSTATE_ENABLED   = 0;
this.GOANNA_RADIOSTATE_DISABLED  = 1;

// Only used in ril_worker.js
this.GOANNA_CARDSTATE_UNINITIALIZED = 4294967294; // UINT32_MAX - 1
// See nsIIcc::CARD_STATE_*
this.GOANNA_CARDSTATE_UNDETECTED = 4294967295; // UINT32_MAX
this.GOANNA_CARDSTATE_UNKNOWN = 0;
this.GOANNA_CARDSTATE_READY = 1;
this.GOANNA_CARDSTATE_PIN_REQUIRED = 2;
this.GOANNA_CARDSTATE_PUK_REQUIRED = 3;
this.GOANNA_CARDSTATE_PERMANENT_BLOCKED = 4;
this.GOANNA_CARDSTATE_PERSONALIZATION_IN_PROGRESS = 5;
this.GOANNA_CARDSTATE_PERSONALIZATION_READY = 6;
this.GOANNA_CARDSTATE_NETWORK_LOCKED = 7;
this.GOANNA_CARDSTATE_NETWORK_SUBSET_LOCKED = 8;
this.GOANNA_CARDSTATE_CORPORATE_LOCKED = 9;
this.GOANNA_CARDSTATE_SERVICE_PROVIDER_LOCKED = 10;
this.GOANNA_CARDSTATE_SIM_LOCKED = 11;
this.GOANNA_CARDSTATE_NETWORK_PUK_REQUIRED = 12;
this.GOANNA_CARDSTATE_NETWORK_SUBSET_PUK_REQUIRED = 13;
this.GOANNA_CARDSTATE_CORPORATE_PUK_REQUIRED = 14;
this.GOANNA_CARDSTATE_SERVICE_PROVIDER_PUK_REQUIRED = 15;
this.GOANNA_CARDSTATE_SIM_PUK_REQUIRED = 16;
this.GOANNA_CARDSTATE_NETWORK1_LOCKED = 17;
this.GOANNA_CARDSTATE_NETWORK2_LOCKED = 18;
this.GOANNA_CARDSTATE_HRPD_NETWORK_LOCKED = 19;
this.GOANNA_CARDSTATE_RUIM_CORPORATE_LOCKED = 20;
this.GOANNA_CARDSTATE_RUIM_SERVICE_PROVIDER_LOCKED = 21;
this.GOANNA_CARDSTATE_RUIM_LOCKED = 22;
this.GOANNA_CARDSTATE_NETWORK1_PUK_REQUIRED = 23;
this.GOANNA_CARDSTATE_NETWORK2_PUK_REQUIRED = 24;
this.GOANNA_CARDSTATE_HRPD_NETWORK_PUK_REQUIRED = 25;
this.GOANNA_CARDSTATE_RUIM_CORPORATE_PUK_REQUIRED = 26;
this.GOANNA_CARDSTATE_RUIM_SERVICE_PROVIDER_PUK_REQUIRED = 27;
this.GOANNA_CARDSTATE_RUIM_PUK_REQUIRED = 28;
this.GOANNA_CARDSTATE_ILLEGAL = 29;

// See nsIIcc::CARD_LOCK_TYPE_*
this.GOANNA_CARDLOCK_PIN = 0;
this.GOANNA_CARDLOCK_PIN2 = 1;
this.GOANNA_CARDLOCK_PUK = 2;
this.GOANNA_CARDLOCK_PUK2 = 3;
this.GOANNA_CARDLOCK_NCK = 4;
this.GOANNA_CARDLOCK_NSCK = 5;
this.GOANNA_CARDLOCK_NCK1 = 6;
this.GOANNA_CARDLOCK_NCK2 = 7;
this.GOANNA_CARDLOCK_HNCK = 8;
this.GOANNA_CARDLOCK_CCK = 9;
this.GOANNA_CARDLOCK_SPCK = 10;
this.GOANNA_CARDLOCK_PCK = 11;
this.GOANNA_CARDLOCK_RCCK = 12;
this.GOANNA_CARDLOCK_RSPCK = 13;
this.GOANNA_CARDLOCK_NCK_PUK = 14;
this.GOANNA_CARDLOCK_NSCK_PUK = 15;
this.GOANNA_CARDLOCK_NCK1_PUK = 16;
this.GOANNA_CARDLOCK_NCK2_PUK = 17;
this.GOANNA_CARDLOCK_HNCK_PUK = 18;
this.GOANNA_CARDLOCK_CCK_PUK = 19;
this.GOANNA_CARDLOCK_SPCK_PUK = 20;
this.GOANNA_CARDLOCK_PCK_PUK = 21;
this.GOANNA_CARDLOCK_RCCK_PUK = 22;
this.GOANNA_CARDLOCK_RSPCK_PUK = 23;
this.GOANNA_CARDLOCK_FDN = 24;

this.GOANNA_CARDLOCK_TO_FACILITY = {};
GOANNA_CARDLOCK_TO_FACILITY[GOANNA_CARDLOCK_PIN] = ICC_CB_FACILITY_SIM;
GOANNA_CARDLOCK_TO_FACILITY[GOANNA_CARDLOCK_FDN] = ICC_CB_FACILITY_FDN;

this.GOANNA_CARDLOCK_TO_SEL_CODE = {};
GOANNA_CARDLOCK_TO_SEL_CODE[GOANNA_CARDLOCK_PIN] = ICC_SEL_CODE_SIM_PIN;
GOANNA_CARDLOCK_TO_SEL_CODE[GOANNA_CARDLOCK_PIN2] = ICC_SEL_CODE_SIM_PIN2;
GOANNA_CARDLOCK_TO_SEL_CODE[GOANNA_CARDLOCK_PUK] = ICC_SEL_CODE_SIM_PUK;
GOANNA_CARDLOCK_TO_SEL_CODE[GOANNA_CARDLOCK_PUK2] = ICC_SEL_CODE_SIM_PUK2;
GOANNA_CARDLOCK_TO_SEL_CODE[GOANNA_CARDLOCK_NCK] = ICC_SEL_CODE_PH_NET_PIN;
GOANNA_CARDLOCK_TO_SEL_CODE[GOANNA_CARDLOCK_NSCK] = ICC_SEL_CODE_PH_NETSUB_PIN;
GOANNA_CARDLOCK_TO_SEL_CODE[GOANNA_CARDLOCK_CCK] = ICC_SEL_CODE_PH_CORP_PIN;
GOANNA_CARDLOCK_TO_SEL_CODE[GOANNA_CARDLOCK_SPCK] = ICC_SEL_CODE_PH_SP_PIN;
// TODO: Bug 1116072: identify the mapping between RIL_PERSOSUBSTATE_SIM_SIM @
//       ril.h and TS 27.007, clause 8.65 for GOANNA_CARDLOCK_PCK.

// See nsIIcc::CARD_CONTACT_TYPE_*
this.GOANNA_CARDCONTACT_TYPE_ADN = 0;
this.GOANNA_CARDCONTACT_TYPE_FDN = 1;
this.GOANNA_CARDCONTACT_TYPE_SDN = 2;

// See nsIIcc::CARD_MVNO_TYPE_*
this.GOANNA_CARDMVNO_TYPE_IMSI = 0;
this.GOANNA_CARDMVNO_TYPE_SPN = 1;
this.GOANNA_CARDMVNO_TYPE_GID = 2;

// See nsIIcc::CARD_SERVICE_*
this.GOANNA_CARDSERVICE_FDN = 0;

// See ril.h RIL_PersoSubstate
this.PERSONSUBSTATE = {};
PERSONSUBSTATE[CARD_PERSOSUBSTATE_UNKNOWN] = GOANNA_CARDSTATE_UNKNOWN;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_IN_PROGRESS] = GOANNA_CARDSTATE_PERSONALIZATION_IN_PROGRESS;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_READY] = GOANNA_CARDSTATE_PERSONALIZATION_READY;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_SIM_NETWORK] = GOANNA_CARDSTATE_NETWORK_LOCKED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_SIM_NETWORK_SUBSET] = GOANNA_CARDSTATE_NETWORK_SUBSET_LOCKED;
...
PERSONSUBSTATE[CARD_PERSOSUBSTATE_SIM_SIM] = GOANNA_CARDSTATE_SIM_LOCKED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_SIM_NETWORK_PUK] = GOANNA_CARDSTATE_NETWORK_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_SIM_NETWORK_SUBSET_PUK] = GOANNA_CARDSTATE_NETWORK_SUBSET_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_SIM_CORPORATE_PUK] = GOANNA_CARDSTATE_CORPORATE_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_SIM_SERVICE_PROVIDER_PUK] = GOANNA_CARDSTATE_SERVICE_PROVIDER_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_SIM_SIM_PUK] = GOANNA_CARDSTATE_SIM_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_NETWORK1] = GOANNA_CARDSTATE_NETWORK1_LOCKED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_NETWORK2] = GOANNA_CARDSTATE_NETWORK2_LOCKED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_HRPD] = GOANNA_CARDSTATE_HRPD_NETWORK_LOCKED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_CORPORATE] = GOANNA_CARDSTATE_RUIM_CORPORATE_LOCKED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_SERVICE_PROVIDER] = GOANNA_CARDSTATE_RUIM_SERVICE_PROVIDER_LOCKED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_RUIM] = GOANNA_CARDSTATE_RUIM_LOCKED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_NETWORK1_PUK] = GOANNA_CARDSTATE_NETWORK1_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_NETWORK2_PUK] = GOANNA_CARDSTATE_NETWORK2_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_HRPD_PUK] = GOANNA_CARDSTATE_HRPD_NETWORK_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_CORPORATE_PUK] = GOANNA_CARDSTATE_RUIM_CORPORATE_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_SERVICE_PROVIDER_PUK] = GOANNA_CARDSTATE_RUIM_SERVICE_PROVIDER_PUK_REQUIRED;
PERSONSUBSTATE[CARD_PERSOSUBSTATE_RUIM_RUIM_PUK] = GOANNA_CARDSTATE_RUIM_PUK_REQUIRED;

// See nsIMobileConnection::NETWORK_SELECTION_MODE_*
this.GOANNA_NETWORK_SELECTION_UNKNOWN   = -1;
this.GOANNA_NETWORK_SELECTION_AUTOMATIC = 0;
this.GOANNA_NETWORK_SELECTION_MANUAL    = 1;
...
NETWORK_CREG_TO_GOANNA_MOBILE_CONNECTION_STATE[NETWORK_CREG_STATE_SEARCHING] = GOANNA_MOBILE_CONNECTION_STATE_SEARCHING;
...
this.GOANNA_CALL_ERROR_NO_ROUTE_TO_DESTINATION = "NoRouteToDestinationError";
this.GOANNA_CALL_ERROR_CHANNEL_UNACCEPTABLE = "ChannelUnacceptableError";
this.GOANNA_CALL_ERROR_OPERATOR_DETERMINED_BARRING = "OperatorDeterminedBarringError";
...
this.GOANNA_CALL_ERROR_REJECTED_DETINATION_FEATURE = "CallRejectedDestinationFeatureError";
...
this.GOANNA_CALL_ERROR_RESPONSE_TO_STATUS_ENQUIRY = "ResponseToStatusEnquiryError";
...
this.GOANNA_CALL_ERROR_SWITCHING_EQUIP_CONGESTION = "SwitchingEquipCongestionError";
this.GOANNA_CALL_ERROR_ACCESS_INFO_DISCARDED = "AccessInfoDiscardedError";
this.GOANNA_CALL_ERROR_REQUESTED_CHANNEL_NOT_AVAILABLE = "RequestedChannelNotAvailableError";
this.GOANNA_CALL_ERROR_RESOURCE_UNAVAILABLE = "ResourceUnavailableError";
this.GOANNA_CALL_ERROR_QOS_UNAVAILABLE = "QosUnavailableError";
this.GOANNA_CALL_ERROR_REQUESTED_FACILITY_NOT_SUBSCRIBED = "RequestedFacilityNotSubscribedError";
this.GOANNA_CALL_ERROR_INCOMING_CALLS_BARRED_WITHIN_CUG = "IncomingCallsBarredWithinCugError";
this.GOANNA_CALL_ERROR_BEARER_CAPABILITY_NOT_AUTHORIZED = "BearerCapabilityNotAuthorizedError";
this.GOANNA_CALL_ERROR_BEARER_CAPABILITY_NOT_AVAILABLE = "BearerCapabilityNotAvailableError";
this.GOANNA_CALL_ERROR_BEARER_NOT_IMPLEMENTED = "BearerNotImplementedError";
this.GOANNA_CALL_ERROR_SERVICE_NOT_AVAILABLE = "ServiceNotAvailableError";
this.GOANNA_CALL_ERROR_INCOMING_CALL_EXCEEDED = "IncomingCallExceededError";
this.GOANNA_CALL_ERROR_REQUESTED_FACILITY_NOT_IMPLEMENTED = "RequestedFacilityNotImplementedError";
this.GOANNA_CALL_ERROR_UNRESTRICTED_BEARER_NOT_AVAILABLE = "UnrestrictedBearerNotAvailableError";
this.GOANNA_CALL_ERROR_SERVICE_NOT_IMPLEMENTED = "ServiceNotImplementedError";
this.GOANNA_CALL_ERROR_INVALID_TRANSACTION_ID = "InvalidTransactionIdError";
this.GOANNA_CALL_ERROR_USER_NOT_CUG_MEMBER = "NotCugMemberError";
this.GOANNA_CALL_ERROR_INCOMPATIBLE_DESTINATION = "IncompatibleDestinationError";
this.GOANNA_CALL_ERROR_INVALID_TRANSIT_NETWORK_SELECTION = "InvalidTransitNetworkSelectionError";
this.GOANNA_CALL_ERROR_SEMANTICALLY_INCORRECT_MESSAGE = "SemanticallyIncorrectMessageError";
this.GOANNA_CALL_ERROR_INVALID_MANDATORY_INFO = "InvalidMandatoryInfoError";
this.GOANNA_CALL_ERROR_MESSAGE_TYPE_NOT_IMPLEMENTED = "MessageTypeNotImplementedError";
this.GOANNA_CALL_ERROR_MESSAGE_TYPE_INCOMPATIBLE_PROTOCOL_STATE = "MessageTypeIncompatibleProtocolStateError";
this.GOANNA_CALL_ERROR_INFO_ELEMENT_NOT_IMPLEMENTED = "InfoElementNotImplementedError";
this.GOANNA_CALL_ERROR_CONDITIONAL_IE = "ConditionalIeError";
this.GOANNA_CALL_ERROR_MESSAGE_INCOMPATIBLE_PROTOCOL_STATE = "MessageIncompatibleProtocolStateError";
this.GOANNA_CALL_ERROR_RECOVERY_ON_TIMER_EXPIRY = "RecoveryOnTimerExpiryError";
this.GOANNA_CALL_ERROR_PROTOCOL = "ProtocolError";
this.GOANNA_CALL_ERROR_INTERWORKING = "InterworkingError";
...
this.GOANNA_CALL_ERROR_MODIFIED_TO_DIAL_FAILED = "ModifiedDialError";
this.GOANNA_CALL_ERROR_CDMA_LOCKED_UNTIL_POWER_CYCLE = "CdmaLockedUntilPowerCycleError";
this.GOANNA_CALL_ERROR_CDMA_DROP = "CdmaDropError";
this.GOANNA_CALL_ERROR_CDMA_INTERCEPT = "CdmaInterceptError";
this.GOANNA_CALL_ERROR_CDMA_REORDER = "CdmaReorderError";
this.GOANNA_CALL_ERROR_CDMA_SO_REJECT = "CdmaSoRejectError";
this.GOANNA_CALL_ERROR_CDMA_RETRY_ORDER = "CdmaRetryOrderError";
this.GOANNA_CALL_ERROR_CDMA_ACCESS_FAILURE = "CdmaAcessError";
this.GOANNA_CALL_ERROR_CDMA_PREEMPTED = "CdmaPreemptedError";
this.GOANNA_CALL_ERROR_CDMA_NOT_EMERGENCY = "CdmaNotEmergencyError";
this.GOANNA_CALL_ERROR_CDMA_ACCESS_BLOCKED = "CdmaAccessBlockedError";
...
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_NO_ROUTE_TO_DESTINATION] = GOANNA_CALL_ERROR_NO_ROUTE_TO_DESTINATION;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CHANNEL_UNACCEPTABLE] = GOANNA_CALL_ERROR_CHANNEL_UNACCEPTABLE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_OPERATOR_DETERMINED_BARRING] = GOANNA_CALL_ERROR_OPERATOR_DETERMINED_BARRING;
...
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CALL_REJECTED_DESTINATION_FEATURE] = GOANNA_CALL_ERROR_REJECTED_DETINATION_FEATURE;
...
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_RESPONSE_TO_STATUS_ENQUIRY] = GOANNA_CALL_ERROR_RESPONSE_TO_STATUS_ENQUIRY;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_NORMAL_UNSPECIFIED] = GOANNA_CALL_ERROR_NORMAL_CALL_CLEARING;
...
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_SWITCHING_EQUIP_CONGESTION] = GOANNA_CALL_ERROR_SWITCHING_EQUIP_CONGESTION;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_ACCESS_INFO_DISCARDED] = GOANNA_CALL_ERROR_ACCESS_INFO_DISCARDED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_REQUESTED_CHANNEL_NOT_AVAILABLE] = GOANNA_CALL_ERROR_REQUESTED_CHANNEL_NOT_AVAILABLE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_RESOURCE_UNAVAILABLE] = GOANNA_CALL_ERROR_RESOURCE_UNAVAILABLE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_QOS_UNAVAILABLE] = GOANNA_CALL_ERROR_QOS_UNAVAILABLE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_REQUESTED_FACILITY_NOT_SUBSCRIBED] = GOANNA_CALL_ERROR_REQUESTED_FACILITY_NOT_SUBSCRIBED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_INCOMING_CALLS_BARRED_WITHIN_CUG] = GOANNA_CALL_ERROR_INCOMING_CALLS_BARRED_WITHIN_CUG;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_BEARER_CAPABILITY_NOT_AUTHORIZED] = GOANNA_CALL_ERROR_BEARER_CAPABILITY_NOT_AUTHORIZED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_BEARER_CAPABILITY_NOT_AVAILABLE] = GOANNA_CALL_ERROR_BEARER_CAPABILITY_NOT_AVAILABLE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_SERVICE_NOT_AVAILABLE] = GOANNA_CALL_ERROR_SERVICE_NOT_AVAILABLE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_BEARER_NOT_IMPLEMENTED] = GOANNA_CALL_ERROR_BEARER_NOT_IMPLEMENTED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_ACM_LIMIT_EXCEEDED] = GOANNA_CALL_ERROR_INCOMING_CALL_EXCEEDED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_REQUESTED_FACILITY_NOT_IMPLEMENTED] = GOANNA_CALL_ERROR_REQUESTED_FACILITY_NOT_IMPLEMENTED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_UNRESTRICTED_BEARER_NOT_AVAILABLE] = GOANNA_CALL_ERROR_UNRESTRICTED_BEARER_NOT_AVAILABLE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_SERVICE_NOT_IMPLEMENTED] = GOANNA_CALL_ERROR_SERVICE_NOT_IMPLEMENTED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_INVALID_TRANSACTION_ID] = GOANNA_CALL_ERROR_INVALID_TRANSACTION_ID;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_USER_NOT_CUG_MEMBER] = GOANNA_CALL_ERROR_USER_NOT_CUG_MEMBER;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_INCOMPATIBLE_DESTINATION] = GOANNA_CALL_ERROR_INCOMPATIBLE_DESTINATION;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_INVALID_TRANSIT_NETWORK_SELECTION] = GOANNA_CALL_ERROR_INVALID_TRANSIT_NETWORK_SELECTION;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_SEMANTICALLY_INCORRECT_MESSAGE] = GOANNA_CALL_ERROR_SEMANTICALLY_INCORRECT_MESSAGE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_INVALID_MANDATORY_INFO] = GOANNA_CALL_ERROR_INVALID_MANDATORY_INFO;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_MESSAGE_TYPE_NOT_IMPLEMENTED] = GOANNA_CALL_ERROR_MESSAGE_TYPE_NOT_IMPLEMENTED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_MESSAGE_TYPE_INCOMPATIBLE_PROTOCOL_STATE] = GOANNA_CALL_ERROR_MESSAGE_TYPE_INCOMPATIBLE_PROTOCOL_STATE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_INFO_ELEMENT_NOT_IMPLEMENTED] = GOANNA_CALL_ERROR_INFO_ELEMENT_NOT_IMPLEMENTED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CONDITIONAL_IE_ERROR] = GOANNA_CALL_ERROR_CONDITIONAL_IE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_MESSAGE_INCOMPABITLE_PROTOCOL_STATE] = GOANNA_CALL_ERROR_MESSAGE_INCOMPATIBLE_PROTOCOL_STATE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_RECOVERY_ON_TIMER_EXPIRY] = GOANNA_CALL_ERROR_RECOVERY_ON_TIMER_EXPIRY;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_PROTOCOL_ERROR] = GOANNA_CALL_ERROR_PROTOCOL;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_INTERWORKING] = GOANNA_CALL_ERROR_INTERWORKING;
...
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_DIAL_MODIFIED_TO_USSD] = GOANNA_CALL_ERROR_MODIFIED_TO_DIAL_FAILED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_DIAL_MODIFIED_TO_SS] = GOANNA_CALL_ERROR_MODIFIED_TO_DIAL_FAILED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_DIAL_MODIFIED_TO_DIAL] = GOANNA_CALL_ERROR_MODIFIED_TO_DIAL_FAILED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_LOCKED_UNTIL_POWER_CYCLE] = GOANNA_CALL_ERROR_CDMA_LOCKED_UNTIL_POWER_CYCLE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_DROP] = GOANNA_CALL_ERROR_CDMA_DROP;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_INTERCEPT] = GOANNA_CALL_ERROR_CDMA_INTERCEPT;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_REORDER] = GOANNA_CALL_ERROR_CDMA_REORDER;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_SO_REJECT] = GOANNA_CALL_ERROR_CDMA_SO_REJECT;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_RETRY_ORDER] = GOANNA_CALL_ERROR_CDMA_RETRY_ORDER;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_ACCESS_FAILURE] = GOANNA_CALL_ERROR_CDMA_ACCESS_FAILURE;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_PREEMPTED] = GOANNA_CALL_ERROR_CDMA_PREEMPTED;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_NOT_EMERGENCY] = GOANNA_CALL_ERROR_CDMA_NOT_EMERGENCY;
RIL_CALL_FAILCAUSE_TO_GOANNA_CALL_ERROR[CALL_FAIL_CDMA_ACCESS_BLOCKED] = GOANNA_CALL_ERROR_CDMA_ACCESS_BLOCKED;
...
this.GOANNA_SUPP_SVC_NOTIFICATION_REMOTE_HELD    = "RemoteHeld";
this.GOANNA_SUPP_SVC_NOTIFICATION_REMOTE_RESUMED = "RemoteResumed";

this.GOANNA_SUPP_SVC_NOTIFICATION_FROM_CODE2 = {};
GOANNA_SUPP_SVC_NOTIFICATION_FROM_CODE2[SUPP_SVC_NOTIFICATION_CODE2_PUT_ON_HOLD] = GOANNA_SUPP_SVC_NOTIFICATION_REMOTE_HELD;
GOANNA_SUPP_SVC_NOTIFICATION_FROM_CODE2[SUPP_SVC_NOTIFICATION_CODE2_RETRIEVED]   = GOANNA_SUPP_SVC_NOTIFICATION_REMOTE_RESUMED;
 ...
 * @see 3GPP2 C.S0016
 */
this.GOANNA_OTA_STATUS_SPL_UNLOCKED          = "spl_unlocked";
this.GOANNA_OTA_STATUS_SPC_RETRIES_EXCEEDED  = "spc_retries_exceeded";
this.GOANNA_OTA_STATUS_A_KEY_EXCHANGED       = "a_key_exchanged";
this.GOANNA_OTA_STATUS_SSD_UPDATED           = "ssd_updated";
this.GOANNA_OTA_STATUS_NAM_DOWNLOADED        = "nam_downloaded";
this.GOANNA_OTA_STATUS_MDN_DOWNLOADED        = "mdn_downloaded";
this.GOANNA_OTA_STATUS_IMSI_DOWNLOADED       = "imsi_downloaded";
this.GOANNA_OTA_STATUS_PRL_DOWNLOADED        = "prl_downloaded";
this.GOANNA_OTA_STATUS_COMMITTED             = "committed";
this.GOANNA_OTA_STATUS_OTAPA_STARTED         = "otapa_started";
this.GOANNA_OTA_STATUS_OTAPA_STOPPED         = "otapa_stopped";
this.GOANNA_OTA_STATUS_OTAPA_ABORTED         = "otapa_aborted";
this.CDMA_OTA_PROVISION_STATUS_TO_GOANNA = [
  GOANNA_OTA_STATUS_SPL_UNLOCKED,
  GOANNA_OTA_STATUS_SPC_RETRIES_EXCEEDED,
  GOANNA_OTA_STATUS_A_KEY_EXCHANGED,
  GOANNA_OTA_STATUS_SSD_UPDATED,
  GOANNA_OTA_STATUS_NAM_DOWNLOADED,
  GOANNA_OTA_STATUS_MDN_DOWNLOADED,
  GOANNA_OTA_STATUS_IMSI_DOWNLOADED,
  GOANNA_OTA_STATUS_PRL_DOWNLOADED,
  GOANNA_OTA_STATUS_COMMITTED,
  GOANNA_OTA_STATUS_OTAPA_STARTED,
  GOANNA_OTA_STATUS_OTAPA_STOPPED,
  GOANNA_OTA_STATUS_OTAPA_ABORTED
];
