...
public class DistributionStoreCallback implements Distribution.ReadyCallback {
    private static final String LOGTAG = "Goanna" + DistributionStoreCallback.class.getSimpleName();
    ...
    private void storeDistribution(final Distribution distribution) {
        ...
        final SharedPreferences sharedPrefs = GoannaSharedPrefs.forProfileName(context, profileName);
