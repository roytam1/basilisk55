...
import org.mozilla.goanna.background.fxa.oauth.FxAccountAbstractClient;
...
import org.mozilla.goanna.sync.repositories.android.ClientsDatabase;
...
public class FxAccountDeletedService extends IntentService {
  ...
  protected void onHandleIntent(final Intent intent) {
    ...
    // Fire up goanna and unsubscribe push
    final Intent goannaIntent = new Intent();
    goannaIntent.setAction("create-services");
    goannaIntent.setClassName(context, "org.mozilla.goanna.GoannaService");
    goannaIntent.putExtra("category", "android-push-service");
    goannaIntent.putExtra("data", "android-fxa-unsubscribe");
    final AndroidFxAccount fxAccount = AndroidFxAccount.fromContext(context);
    goannaIntent.putExtra("org.mozilla.goanna.intent.PROFILE_NAME",
