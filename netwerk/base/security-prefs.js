...
pref("security.ssl3.ecdhe_rsa_camellia_256_sha384", true);
pref("security.ssl3.ecdhe_ecdsa_camellia_128_sha256", true);
pref("security.ssl3.ecdhe_rsa_camellia_128_sha256", true);
