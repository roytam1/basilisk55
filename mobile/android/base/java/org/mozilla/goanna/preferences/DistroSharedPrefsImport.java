...
public class DistroSharedPrefsImport {
    ...
    public static void importPreferences(final Context context, final Distribution distribution) {
        ...
        final SharedPreferences.Editor sharedPreferences = GoannaSharedPrefs.forProfile(context).edit();
        ...
        while (keys.hasNext()) {
            ...
            if (value instanceof String) {
                sharedPreferences.putString(GoannaPreferences.NON_PREF_PREFIX + key, (String) value);
            } else if (value instanceof Boolean) {
                sharedPreferences.putBoolean(GoannaPreferences.NON_PREF_PREFIX + key, (boolean) value);
            } else if (value instanceof Integer) {
                sharedPreferences.putInt(GoannaPreferences.NON_PREF_PREFIX + key, (int) value);
            } else if (value instanceof Long) {
                sharedPreferences.putLong(GoannaPreferences.NON_PREF_PREFIX + key, (long) value);
            } else {
