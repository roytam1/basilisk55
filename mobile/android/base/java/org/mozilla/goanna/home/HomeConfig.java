...
public final class HomeConfig {
   ...
   /**
    ...
    public static class Editor implements Iterable<PanelConfig> {
        ...
        // Each Pair represents parameters to a GoannaAppShell.notifyObservers call;
        ...
        public State apply() {
            ...
            ThreadUtils.getBackgroundHandler().post(new Runnable() {
                ...
                public void run() {
                    ...
                    sendNotificationsToGoanna(copiedQueue);
                }
            });
        ...
        public State commit() {
            ...
            // Send pending events after the new config is saved.
            sendNotificationsToGoanna(mNotificationQueue);
        ...
        private void sendNotificationsToGoanna(List<Pair<String, String>> notifications) {
            for (Pair<String, String> p : notifications) {
                GoannaAppShell.notifyObservers(p.first, p.second);
            }
        }
