...
extern MOZ_THREAD_LOCAL(GoannaSampler *) tlsTicker;
...
class MOZ_RAII GoannaProfilerInitRAII {
public:
...
class MOZ_RAII GoannaProfilerSleepRAII {
public:
 ...
 */
class MOZ_RAII GoannaProfilerWakeRAII {
public:
  GoannaProfilerWakeRAII()
...
class MOZ_RAII GoannaProfilerTracingRAII {
public:
