...
package org.mozilla.goanna.annotation;
...
public @interface WrapForJNI {
     ...
     * One of "any", "goanna", or "ui". Not supported for fields.
     */
    String calledFrom() default "any";

    /**
     * The thread that the method call will be dispatched to.
     * One of "current", "goanna", or "proxy". Not supported for non-native methods,
