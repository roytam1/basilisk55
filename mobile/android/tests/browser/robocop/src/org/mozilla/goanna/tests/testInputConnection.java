...
import static org.mozilla.goanna.tests.helpers.WaitHelper.waitFor;
...
public class testInputConnection extends JavascriptBridgeTest {
    ...
    private class BasicInputConnectionTest extends InputConnectionTest {
        ...
        public void test(final InputConnection ic, EditorInfo info) {
            ...
            // Goanna will change text to 'abc' when we input 'b', potentially causing
    ...
    private class ResettingInputConnectionTest extends InputConnectionTest {
        ...
        public void test(final InputConnection ic, EditorInfo info) {
            ...
            // issue these events after some back-and-forth calls between the Goanna thread
            // and the input connection thread. Therefore, to ensure these events are
            // issued and to ensure the bug appears, we have to process all Goanna events,
            // then all input connection events, and finally all Goanna events again.
            processGoannaEvents();
            processInputConnectionEvents();
            processGoannaEvents();
