...
class DroidMixin(object):
    ...
    def launchFennec(self, appName, intent="android.intent.action.VIEW",
        ...
        self.launchApplication(appName, "org.mozilla.goanna.BrowserApp", intent, url=url,
                               extras=extras,
...
class DroidADB(DeviceManagerADB, DroidMixin):
    ...
    def getTopActivity(self):
        ...
        # or, on other devices:
        #   FocusedApplication: name='AppWindowToken{41a65340 token=ActivityRecord{418fbd68 org.mozilla.fennec_mozdev/org.mozilla.goanna.BrowserApp}}', dispatchingTimeout=5000.000ms # noqa
