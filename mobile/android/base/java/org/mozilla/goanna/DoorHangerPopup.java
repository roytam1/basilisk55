...
public class DoorHangerPopup extends AnchoredPopup
    ...
    @Override
    public void handleMessage(final String event, final GoannaBundle goannaObject,
                              final EventCallback callback) {
        if (event.equals("Doorhanger:Add")) {
            final DoorhangerConfig config = makeConfigFromBundle(goannaObject);
    ...
    private DoorhangerConfig makeConfigFromBundle(final GoannaBundle bundle) {
        ...
        final GoannaBundle[] buttonArray = bundle.getBundleArray("buttons");
        ...
        for (int i = 0; i < numButtons; i++) {
            final GoannaBundle button = buttonArray[i];
    ...
    public void onButtonClick(JSONObject response, DoorHanger doorhanger) {
        GoannaAppShell.notifyObservers("Doorhanger:Reply", response.toString());
        removeDoorHanger(doorhanger);
        updatePopup();
    }
