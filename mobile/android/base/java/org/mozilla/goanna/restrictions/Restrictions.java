...
package org.mozilla.goanna.restrictions;
...
public class Restrictions {
    ...
    private static boolean isGuestProfile(Context context) {
        ...
        GoannaAppShell.GoannaInterface goannaInterface = GoannaAppShell.getGoannaInterface();
        if (goannaInterface != null) {
            return goannaInterface.getProfile().inGuestMode();
        }

        return GoannaProfile.get(context).inGuestMode();
    }
    ...
    private static Restrictable goannaActionToRestriction(int action) {
    ...
    public static boolean isUserRestricted() {
        return isUserRestricted(GoannaAppShell.getApplicationContext());
    }
    ...
    public static boolean isAllowed(int action, String url) {
        ...
        try {
            restrictable = goannaActionToRestriction(action);
