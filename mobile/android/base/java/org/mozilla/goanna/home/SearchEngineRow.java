...
import org.mozilla.goanna.home.BrowserSearch.OnEditSuggestionListener;
import org.mozilla.goanna.home.BrowserSearch.OnSearchListener;
...
import org.mozilla.goanna.widget.AnimatedHeightLayout;
import org.mozilla.goanna.widget.FaviconView;
import org.mozilla.goanna.widget.FlowLayout;
...
class SearchEngineRow extends AnimatedHeightLayout {
    ...
    public void updateSuggestions(boolean searchSuggestionsEnabled, SearchEngine searchEngine, @Nullable List<String> rawSearchHistorySuggestions, boolean animate) {
        ...
        final boolean savedSearchesEnabled = prefs.getBoolean(GoannaPreferences.PREFS_HISTORY_SAVED_SEARCH, true);
