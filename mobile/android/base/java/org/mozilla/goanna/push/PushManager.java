...
public class PushManager {
    ...
    private static final String LOG_TAG = "GoannaPushManager";
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                try {
                    ...
                    Log.i(LOG_TAG, "Startup: cannot advance registration for profileName: " + profileName + "; profile needs configuration from Goanna.");
