...
import org.mozilla.goanna.home.SearchEngineBar;
...
public class testAddSearchEngine extends AboutHomeTest {
    ...
    public void testAddSearchEngine() {
        ...
        // Get the searchengine data by clicking the awesomebar - this causes Goanna to
        ...
        GoannaBundle eventData = searchEngineDataEventExpector.blockForBundle();
        ...
        final File f = GoannaProfile.get(getActivity())
     ...
     * engine information object sent from Goanna.
     ...
     */
    public ArrayList<String> getSearchEnginesNames(final GoannaBundle data) {
