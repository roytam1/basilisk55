...
public class HomeBanner extends LinearLayout
    ...
    public void onAttachedToWindow() {
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                GoannaAppShell.notifyObservers("HomeBanner:Dismiss", (String) getTag());
            }
        });
        ...
        setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Send the current message id back to JS.
                GoannaAppShell.notifyObservers("HomeBanner:Click", (String) getTag());
            }
        });
     ...
     */
    public void update() {
        GoannaAppShell.notifyObservers("HomeBanner:Get", null);
    }
    ...
    public void handleMessage(String event, JSONObject message) {
        ...
        ThreadUtils.postToUiThread(new Runnable() {
            ...
            public void run() {
                ...
                GoannaAppShell.notifyObservers("HomeBanner:Shown", id);
