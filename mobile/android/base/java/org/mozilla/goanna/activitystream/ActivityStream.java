...
package org.mozilla.goanna.activitystream;
...
import org.mozilla.goanna.util.publicsuffix.PublicSuffix;
...
public class ActivityStream {
    ...
    public static boolean isEnabled(Context context) {
        ...
        return GoannaSharedPrefs.forApp(context)
                .getBoolean(GoannaPreferences.PREFS_ACTIVITY_STREAM, false);
    }
