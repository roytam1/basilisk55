...
public abstract class PromptInput {
    ...
    public static class EditInput extends PromptInput {
        ...
        public EditInput(GoannaBundle object) {
            super(object);
    ...
    public static class NumberInput extends EditInput {
        ...
        public NumberInput(GoannaBundle obj) {
            super(obj);
        }
    ...
    public static class PasswordInput extends EditInput {
        ...
        public PasswordInput(GoannaBundle obj) {
            super(obj);
        }
    ...
    public static class CheckboxInput extends PromptInput {
        ...
        public CheckboxInput(GoannaBundle obj) {
            super(obj);
    ...
    public static class DateTimeInput extends PromptInput {
        ...
        public DateTimeInput(GoannaBundle obj) {
            super(obj);
        }
    ...
    public static class MenulistInput extends PromptInput {
        ...
        public MenulistInput(GoannaBundle obj) {
            super(obj);
    ...
    public static class LabelInput extends PromptInput {
        ...
        public LabelInput(GoannaBundle obj) {
            super(obj);
        }
    ...
    public PromptInput(GoannaBundle obj) {
    ...
    public static PromptInput getInput(GoannaBundle obj) {
