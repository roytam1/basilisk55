...
public class SearchEnginePreference extends CustomListPreference {
    ...
    /**
     * Configure this Preference object from the Goanna search engine object.
     * @param goannaEngine The Goanna-formatted object representing the search engine.
     */
    public void setSearchEngineFromBundle(GoannaBundle goannaEngine) {
        mIdentifier = goannaEngine.getString("identifier");
        ...
        final String engineName = goannaEngine.getString("name");
        final SpannableString titleSpannable = new SpannableString(engineName);

        setTitle(titleSpannable);

        final String iconURI = goannaEngine.getString("iconURI");
