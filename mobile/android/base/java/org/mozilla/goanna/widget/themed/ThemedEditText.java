...
package org.mozilla.goanna.widget.themed;
...
public class ThemedEditText extends android.widget.EditText
    ...
    private void initialize(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        // View in an IDE, with no ambient GoannaApplication.
        final Context applicationContext = context.getApplicationContext();
        if (applicationContext instanceof GoannaApplication) {
            theme = ((GoannaApplication) applicationContext).getLightweightTheme();
        }
