...
import org.mozilla.goanna.notifications.WhatsNewReceiver;
...
public class Tabs implements BundleEventListener {
    ...
    public synchronized Tab selectTab(int id) {
        ...
        final GoannaBundle data = new GoannaBundle(1);
    ...
    public synchronized void closeTab(final Tab tab, Tab nextTab, boolean showUndoToast) {
        ...
        // Pass a message to Goanna to update tab state in BrowserApp
        final GoannaBundle data = new GoannaBundle(2);
    ...
    public synchronized void handleMessage(final String event, final GoannaBundle message,
        ...
        if ("Tab:Close".equals(event)) {
            ...
            if (message.getBoolean("foreground", false)) {
                GoannaAppShell.launchOrBringToFront();
            }
            selectTab(tab.getId());
    ...
    public Tab loadUrl(final String url, final String searchEngine, final int parentId,
        ...
        final GoannaBundle data = new GoannaBundle();
