...
import static org.mozilla.goanna.gfx.BitmapUtils.getBitmapFromDataURI;
import static org.mozilla.goanna.gfx.BitmapUtils.getResource;
                ...
                public Drawable doInBackground() {
                    try {
                        if (data.startsWith("jar:jar")) {
                            return GoannaJarReader.getBitmapDrawable(
