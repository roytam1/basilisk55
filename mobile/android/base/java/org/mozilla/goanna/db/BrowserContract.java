...
public class BrowserContract {
    ...
    @RobocopTarget
    public static final class GoannaDisabledHosts {
        private GoannaDisabledHosts() {}
    ...
    public static final String TAB_RECEIVED_SERVICE_CLASS_NAME = "org.mozilla.goanna.tabqueue.TabReceivedService";

    public static final String SKIP_TAB_QUEUE_FLAG = "skip_tab_queue";

    public static final String EXTRA_CLIENT_GUID = "org.mozilla.goanna.extra.CLIENT_ID";
}
