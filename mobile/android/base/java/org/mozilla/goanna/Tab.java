...
import org.mozilla.goanna.icons.IconRequestBuilder;
...
public class Tab {
     ...
     * held by Goanna and the session store.
     *
    ...
    public void updateIdentityData(final GoannaBundle identityData) {
    ...
    public void doReload(boolean bypassCache) {
        GoannaAppShell.notifyObservers("Session:Reload", "{\"bypassCache\":" + String.valueOf(bypassCache) + "}");
    }
    ...
    public boolean doBack() {
        ...
        GoannaAppShell.notifyObservers("Session:Back", "");
        return true;
    }

    public void doStop() {
        GoannaAppShell.notifyObservers("Session:Stop", "");
    }
    ...
    public boolean doForward() {
        ...
        GoannaAppShell.notifyObservers("Session:Forward", "");
        return true;
    }

    void handleLocationChange(final GoannaBundle message) {
