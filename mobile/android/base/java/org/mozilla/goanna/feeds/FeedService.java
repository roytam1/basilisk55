...
package org.mozilla.goanna.feeds;
...
import org.mozilla.goanna.feeds.action.FeedAction;
import org.mozilla.goanna.feeds.action.CheckForUpdatesAction;
import org.mozilla.goanna.feeds.action.EnrollSubscriptionsAction;
import org.mozilla.goanna.feeds.action.SetupAlarmsAction;
import org.mozilla.goanna.feeds.action.SubscribeToFeedAction;
import org.mozilla.goanna.feeds.action.WithdrawSubscriptionsAction;
...
public class FeedService extends IntentService {
    private static final String LOGTAG = "GoannaFeedService";
    ...
    private boolean isPreferenceEnabled() {
        return GoannaSharedPrefs.forApp(this).getBoolean(GoannaPreferences.PREFS_NOTIFICATIONS_CONTENT, true);
    }
}
