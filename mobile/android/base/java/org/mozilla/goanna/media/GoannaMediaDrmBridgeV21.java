...
public class GoannaMediaDrmBridgeV21 implements GoannaMediaDrm {
    ...
    private GoannaMediaDrm.Callbacks mCallbacks;
    ...
    GoannaMediaDrmBridgeV21(String keySystem) throws Exception {
        LOGTAG = getClass().getSimpleName();
        if (DEBUG) Log.d(LOGTAG, "GoannaMediaDrmBridgeV21 ctor");
        ...
        // The caller of GoannaMediaDrmBridgeV21 ctor should handle exceptions
    ...
    @Override
    public void setCallbacks(GoannaMediaDrm.Callbacks callbacks) {
